...
export interface ApiHeroHero extends Schema.SingleType {
  ...
  attributes: {
    ...
    createdBy: Attribute.Relation<'api::hero.hero', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    ctaButton: Attribute.String & Attribute.DefaultTo<'Get Free Consultation'>;
    headline: Attribute.String &
      Attribute.Required &
      Attribute.DefaultTo<'Swabian Consulting UG'>;
    publishedAt: Attribute.DateTime;
    subheadline: Attribute.String &
      Attribute.DefaultTo<'Your trusted business partners'>;
    updatedAt: Attribute.DateTime;
